...
class TableManagerBuilder
{
	struct ConstructureInfo
	{
		...
		std::map<TableTaskHint, TableSplittingInfo*> _tableSplittingInfos;
		std::map<std::string, std::vector<RangeSplittingInfo*>> _rangeSplittingInfos;
