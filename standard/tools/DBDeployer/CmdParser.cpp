...
void showHelp()
{
	...
	cout<<"  show hash tables"<<endl;
	cout<<"  show range tables"<<endl;
	cout<<"  drop table <table_name>"<<endl;
	cout<<"  add hash table <table_name> <table_count> [with hintId field <fiedl_name>] in database <basic_database_name> <database_count>"<<endl;
	cout<<"  add hash table from <sql_file_path> <table_name> <table_count> [with hintId field <fiedl_name>] in database <basic_database_name> <database_count>"<<endl;
	cout<<endl;
...
void addHashTableAction(DBDeployer& deployer, int paramsBeginIdx, const std::vector<std::string>& cmd)
{
	...
	deployer.createHashTable(tableName, sql, hintIdField, tableCount, database, databaseCount);
}
...
void commandLoop(DBDeployer& deployer)
{
	...
	cout<<endl<<"DBDeployer Version: Standard Version"<<endl;
